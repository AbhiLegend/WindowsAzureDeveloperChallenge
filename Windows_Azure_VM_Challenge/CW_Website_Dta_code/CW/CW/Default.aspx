    ...
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                ...
                <h2>This Website is powered by the Windows Azure SQL SErver VM</h2>
            ...
            <p>
                The Data over here is from 1960-2012 as updated by World Bank.</p>
            <p>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:wbapiConnectionString %>" SelectCommand="SELECT * FROM [Sheet1$]"></asp:SqlDataSource>
